...
public class TestTransferir {
	...
	public void mi_nuevo_saldo_es(String saldo) throws Throwable {
		// Write code here that turns the phrase above into concrete actions		
		String saldoActual= webDriver.findElement(By.id("formadministrar:idvalorActual")).getAttribute("value");	
		Assert.assertTrue((Double.valueOf(saldoActual)).equals(Double.valueOf(saldo)));
	}
}
